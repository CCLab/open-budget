(function () {
    ...
    function redraw( parent, sorting ) {
        ...
        paper.clear();
        make_bubbles( paper, get_data( rows, parent ), 'v_total', geometry, sorting );
    }
	...
	sort_button
        ...
        for( i = 0; i < data.length; ++i ) {
            ...
            vis_objects.push({
                ...
                leaf: raw_data[i]['type'] === 'Dysponent' ? true : false,
                idef: raw_data[i]['idef'],
                id: raw_data[i]['idef'].split('-').pop()
            });
