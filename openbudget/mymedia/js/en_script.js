(function () {
    ...
    function get_data( source, parent ) {
        ...
        var result = Tools.filter( function ( element ) {
    ...
    function make_bubbles( canvas, data, key, geometry ) {
        ...
        if( parent_id !== null ) {
            ...
            parent_name = "Performance budget 2011";
        }
    ...
    function create_table() {
        ...
        html.push( '<td class="idef">No.</td>' );
        html.push( '<td class="type">Type</td>' );
        html.push( '<td class="name">Name</td>' );
        html.push( '<td class="eu value">EU funds</td>' );
        html.push( '<td class="pl value">Polish funds</td>' );
        html.push( '<td class="total value">Total</td>' );
